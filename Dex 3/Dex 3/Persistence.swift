...
struct PersistenceController {
    ...
    static var preview: PersistenceController = {
        ...
        samplePokemon.organizeTypes()
        samplePokemon.hp = 45
        samplePokemon.attack = 49
        samplePokemon.defense = 49
        samplePokemon.specialAttack = 64
        samplePokemon.specialDefense = 29
        samplePokemon.speed = 34
    ...
    init(inMemory: Bool = false) {
        ...
        if inMemory {
            ...
            container.persistentStoreDescriptions.first!.url = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.lkostakis.Dex3Group")!.appending(path: "Dex3.sqlite")
        }
